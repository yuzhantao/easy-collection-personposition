...
public class DeviceConfigReadVo implements Serializable{
	...
	private String buzzType; //蜂鸣器状态,范围0~1(0:关,1:开)
	private String ioInput; //地感值,范围0~1(0:无地感,1:有地感)
	...
	private String crcEn; //设备CRC状态,范围0~1(0:取消,1:有效)
	...
	public String getCrcEn() {
		return crcEn;
	}
	public void setCrcEn(String crcEn) {
		this.crcEn = crcEn;
	}
}

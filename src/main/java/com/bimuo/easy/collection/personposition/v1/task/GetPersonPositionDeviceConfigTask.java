...
//	byte[] networkParamsDatas = PersonPositionMessageFactory.createMessage(ByteUtil.intToByteArray(0x58), (byte) 0x47, ByteUtil.intToByteArray(0x41));  // 读取网络参数
//	byte[] port0ConfigDatas = PersonPositionMessageFactory.createMessage(ByteUtil.intToByteArray(0x58), (byte) 0x47, ByteUtil.intToByteArray(0x42));    // 读取端口0配置
//	byte[] port1ConfigDatas = PersonPositionMessageFactory.createMessage(ByteUtil.intToByteArray(0x58), (byte) 0x47, ByteUtil.intToByteArray(0x43));    // 读取端口1配置
//	byte[] port2ConfigDatas = PersonPositionMessageFactory.createMessage(ByteUtil.intToByteArray(0x58), (byte) 0x47, ByteUtil.intToByteArray(0x44));    // 读取端口2配置
//	byte[] port3ConfigDatas = PersonPositionMessageFactory.createMessage(ByteUtil.intToByteArray(0x58), (byte) 0x47, ByteUtil.intToByteArray(0x45));    // 读取端口3配置
...
//	byte[] port1ConfigDatas = {0x02,0x03,0x04,0x05,0x00,0x08,0x00,0x58,0x47,0x00,0x43,(byte) 0xF8}; // 读取端口1配置
//	byte[] port2ConfigDatas = {0x02,0x03,0x04,0x05,0x00,0x08,0x00,0x58,0x47,0x00,0x44,(byte) 0xF9}; // 读取端口2配置
//	byte[] port3ConfigDatas = {0x02,0x03,0x04,0x05,0x00,0x08,0x00,0x58,0x47,0x00,0x45,(byte) 0xFA}; // 读取端口3配置
